// Wedding-album style video frame: matches PhotoFrame's polaroid white
// card mat. Native controls, only loads metadata until the user hits
// play so the 10MB asset isn't fetched on page load.
type Props = {
  src: string;
  poster?: string;
  caption?: string;
